...
const myname = document.getElementById("about-myname");
let showedMyname = false
...
const rickrolling = "TEEPADA";
typeWriter(rick, rickrolling, 0, 100);
...
function setActiveLink() {
  ...
  sections.forEach((section, index) => {
    ...
    if (scrollY >= sectionTop && scrollY < sectionBottom) {
	  ...
	  if (index == 1 && ! showedMyname) {
		const mynameis = "TEEPADA CHUENPREMPREE";
		typeWriter(myname, mynameis, 0, 75);
		showedMyname = true
	  }
    }
  });
